package com.daking.app.client_common.view.imageview;
 ...
 */
public class ImageBtnWithWater extends ImageButton {
    ...
    public ImageBtnWithWater(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPaint();
    ...
    /**
     * 设置水纹特效的颜色
     * @param fgColor 前景色,默认为0xFF3086E4
     * @param bgColor 背景色,默认为0xFFFFFFFF
     */
    public void setWaterColor(int fgColor, int bgColor) {
        colorPaint.setColor(fgColor);
    ...
    private void initPaint() {
        ...
        colorPaint.setColor(getResources().getColor(R.color.waterBtn_fgColor));
        bottomPaint.setColor(getResources().getColor(R.color.waterBtn_bgColor));
    }
